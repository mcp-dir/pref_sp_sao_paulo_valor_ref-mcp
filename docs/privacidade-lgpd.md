...
Prefeitura SP São Paulo: Valor Venal de Referência segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [pref_sp_sao_paulo_valor_ref@mcp.ai](mailto:pref_sp_sao_paulo_valor_ref@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
